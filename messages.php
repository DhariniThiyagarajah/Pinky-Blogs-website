<?php
/**
 * JSON endpoint for the community chat.
 *
 * InfinityFree blocks the filename chat.php, so the public endpoint uses this
 * neutral filename while keeping the same authenticated chat behaviour.
 */

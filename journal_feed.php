<?php
/** Neutral JSON route for the community chat on free hosting. */
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    echo json_encode(['messages' => $payload], JSON_UNESCAPED_UNICODE);
    exit;
}
...
if (empty($_SESSION['chat_csrf']) || !hash_equals($_SESSION['chat_csrf'], $token)) {
